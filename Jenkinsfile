pipeline {
  ...
  environment {
    ...
    TESTING_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::916108123774:role/aws-sam-cli-managed-20210628-PipelineExecutionRole-BX43A50MRGD'
    TESTING_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::916108123774:role/aws-sam-cli-managed-20210-CloudFormationExecutionR-1XU2JJLG5G96C'
    TESTING_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-20210628-pipe-artifactsbucket-1j7bzybfgkpor'
    ...
    PROD_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::916108123774:role/aws-sam-cli-managed-20210628-PipelineExecutionRole-BX43A50MRGD'
    PROD_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::916108123774:role/aws-sam-cli-managed-20210-CloudFormationExecutionR-1XU2JJLG5G96C'
    PROD_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-20210628-pipe-artifactsbucket-1j7bzybfgkpor'
    // If there are functions with "Image" PackageType in your template,
